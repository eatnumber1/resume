...
\section{\mysidestyle Contact \\ Information} \vspace{2mm}
	\begin{asparablank}
		...
		\item PO Box 92423 \hfill \href{http://blog.eatnumber1.com/}{blog.eatnumber1.com}
...
\section{\mysidestyle Experience}
	\begin{asparadesc}
		...
		\small
		Worked on the "Platform Kernel" team in the Core OS department at Apple. The majority of my work entailed work on \emph{libC}, and on \emph{XNU} (the OSX kernel). My two major projects were \begin{inparaenum} \item migrating code out of the kernel into userspace to take advantage of \emph{ASLR} and \item creation of an automated testing suite to test \emph{AICPM} which is used to decide what/when to switch P and C states for the processors installed on the system. \end{inparaenum}
		\normalsize
		\\
		\employer{Gentoo Linux}{Gentoo Foundation}{August 2007 - August 2010}{Package Maintainer}{http://www.gentoo.org/}

		\small
		Maintainer of the PCSX2 ebuilds. An ebuild is a bash script which fetches, unpacks, compiles and installs a piece of software. PCSX2 is a Play Station 2 emulator.
		\normalsize
		\\
...
\section{\mysidestyle Technical Skills \& Certifications}
	\begin{compactdesc}
		\item[Languages] \begin{inparaenum} { \small
			\item Java
			\item C
			\item ZSH, BASH \& other SH derived scripting languages
			\item Python
		} \end{inparaenum}
