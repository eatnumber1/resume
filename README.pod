...
advantage of I<ASLR> and (b) creation of an automated testing suite to test
I<AICPM> which is used to decide what/when to switch P and C states for the processors
