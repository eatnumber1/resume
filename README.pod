...
=item
L<russell@harmon.name>

=item
L<http://russell.harmon.name/>
...
L<http://micorosft.com/>

=back

Worked on the "Sustained Engineering" team on the Application Virtualization
product. The sustained engineering team maintains the released version of App-V.
Written in I<C++>, I worked on an as of yet unreleased feature for the App-V and
Office products.
...
Linux (programming & administration), OSX (kernel programming)
